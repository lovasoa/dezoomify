...
- Beeldbank Groningen (beeldbankgroningen.nl)
- SALHA (salha.nl)
- Archief Zaanstad (archief.zaanstad.nl)
- Regionaal Archief Zutphen (erfgoedcentrumzutphen.nl)
- Noord-Hollands Archief (noord-hollandsarchief.nl)
- Historisch Archief Midden-Groningen (historischarchief.midden-groningen.nl)
- BLB Visual Library Server (digital.blb-karlsruhe.de)
- Hungaricana postcard gallery (gallery.hungaricana.hu)
- Oklahoma State Digital Collections (dc.library.okstate.edu)
- University of Washington Mirador (digitalcollections.lib.washington.edu)
- krpano (krpano.com)
...
- FSI Viewer (neptunelabs.com)
- HNG IIPImage (image.hng-data.org)
- Uffizi XLimage (uffizicloud.centrica.it)
- Cartesius/NGI ArcGIS MapServer (wmts.ngi.be)
- ArcGIS World Imagery WMTS (server.arcgisonline.com)
