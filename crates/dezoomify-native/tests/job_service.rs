//! Consolidated native job service: one engine-driven path for CLI, desktop, and
//! desktop app. These tests exercise the REAL pipeline (loopback HTTP,
//! decode, assemble, encode, atomic publication) through [`start_job`]:
