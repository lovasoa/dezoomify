...
use crate::Vec2d;
use crate::core::{
    DiscoveryError, Grid, ResolvedLevel, Request, floor_index, resolve_url_template,
};
...
pub(crate) fn build_levels(context: &WmtsContext) -> Result<Vec<ResolvedLevel>, DiscoveryError> {
    context
        .matrices
        .iter()
        .enumerate()
