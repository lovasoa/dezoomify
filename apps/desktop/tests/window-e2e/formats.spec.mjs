...
const PNG_MATRIX = [
  { format: "deepzoom", kind: "gateway-dzi", geometry: /512 × 512/ },
  { format: "generic", kind: "gateway-probe", geometry: /512 × 512/ },
  { format: "custom", inputPath: "/custom/tiles.yaml", geometry: /512 × 512/ },
  { format: "zoomify", inputPath: "/zoomify/ImageProperties.xml", geometry: /512 × 512/ },
  { format: "xlimage", inputPath: "/xl/sample.imgi?cmd=info", geometry: /512 × 512/ },
  { format: "fsi", inputPath: "/fsi/server?type=info&source=image&image=image", geometry: /512 × 512/ },
  { format: "vls", inputPath: "/vls/zoom/1", geometry: /512 × 512/ },
  { format: "arcgis", inputPath: "/arcgis/MapServer", geometry: /768 × 768/ },
  { format: "iiif", inputPath: "/fixtures/iiif-v2/info.json", geometry: /512 × 512/ },
  { format: "krpano", inputPath: "/krpano/pano.xml", geometry: /512 × 512/ },
  { format: "iipimage", inputPath: "/iip?FIF=/image.tif", geometry: /512 × 512/ },
  { format: "topviewer", inputPath: "/topviewer/data.json", geometry: /512 × 512/ },
  { format: "lizardtech", inputPath: "/lizardtech/iserv/calcrgn?cat=test&item=test&wid=500&hei=400", geometry: /1024 × 1024/ },
  { format: "hungaricana", inputPath: "/hungaricana/imagesize/sample.ecw", geometry: /512 × 512/ },
  { format: "wmts", inputPath: "/wmts/WMTSCapabilities.xml", geometry: /2816 × 2816/ },
  { format: "pnav", inputPath: "/entity/OBJECT/1", geometry: /256 × 256/ },
  { format: "bulk_text", inputPath: "/bulk/list.txt", geometry: /512 × 512/ },
];
