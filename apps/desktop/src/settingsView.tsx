...
/** Desktop job preferences, including the quick strip and advanced modal. */
    ...
    >
      ...
      >
        <div className="dz-settings-sheet">
          ...
          {showCompression ? (
            <PreferenceRow
              title={jpeg ? t("desktop.advanced.jpegQuality") : t("desktop.advanced.compressionEffort")}
              description={jpeg ? t("desktop.advanced.jpegQualityDesc") : t("desktop.advanced.compressionEffortDesc")}
            >
              <div className="dz-slider-control">
                <input
                  ...
                  min="0"
                  max="100"
                  aria-label={jpeg ? t("desktop.advanced.jpegQuality") : t("desktop.advanced.compressionEffort")}
