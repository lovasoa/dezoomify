// GENERATED from packages/shared-ui/src/components.ts by scripts/sync-web-js.mjs. Do not hand-edit.
// Source of truth: packages/shared-ui/src/components.ts (erasable-syntax TypeScript). Regenerate with:
...
import * as TransportLabels from "./transport-labels.js";
const {
...
export function formatRemaining(elapsedMs        , timeoutMs        )         {
