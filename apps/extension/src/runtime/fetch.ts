...
type FetchOptions = { requestId?: string | number; purpose?: Purpose; headers?: HeaderSource; maxBytes?: number; timeoutMs?: number; cancelled?: () => boolean; userIntent?: boolean };
type FetchDeps = {
...
export function createExtensionFetcher(deps: FetchDeps) {
  ...
  /** @param {string} url @param {{ requestId?: string | number, purpose?: "metadata"|"tile"|"probe", headers?: unknown, maxBytes?: number, timeoutMs?: number, cancelled?: () => boolean }} [opts] */
